...
def printSudoku(sudoku):
    ...
    matrix.append(row1[0:10])
    matrix.append(row2[0:10])
    matrix.append(row3[0:10])
    matrix.append(row4[0:10])
    matrix.append(row5[0:10])
    matrix.append(row6[0:10])
    matrix.append(row7[0:10])
    matrix.append(row8[0:10])
    matrix.append(row9[0:10])
    return matrix
